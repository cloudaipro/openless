...
export const zhTW: typeof zhCN = {
  ...
  onboarding: {
    ...
    hotkeyTitle: '全局快捷鍵',
    accessibilityDesc: '用於監聽全局快捷鍵（預設 {{trigger}}）並把識別結果寫入光標位置。',
  ...
  selectionAsk: {
    ...
    save: {
      ...
      historySaveFailed: 'Q&A 歷史保存設定保存失敗，請重試。',
    },
    history: {
      title: '保存歷史',
  ...
  settings: {
    ...
    recording: {
      ...
      migrationNoticeDesc: '如果你之前改過快捷鍵觸發方式，請在這裏手動確認一次。本次更新調整了快捷鍵方式的預設值與讀取邏輯；如果你更習慣按住說話，可以重新切回“按住說話”。',
    ...
    shortcuts: {
      title: '快捷鍵速查',
      descAcc: '所有快捷鍵全局生效，需要在權限設定中開啓輔助功能。',
    ...
    advanced: {
      ...
      notSupportedHere: '本平台暫不支援，未整合推理模組。',
      enable: '啓用',
      alreadyActive: '已啓用',
      disableLocalLabel: '停用本地 ASR',
      disableLocalDesc: '切回雲端 ASR（預設火山引擎 bigasr）。',
      disable: '停用',
      platformNotSupported: '該平台暫未支援本地 ASR 模型整合。',
  ...
  localAsr: {
    ...
    engineUnavailable: '當前平台暫未整合 Qwen3-ASR 推理引擎。可下載模型，但暫時無法啟用 Qwen3-ASR。',
    ...
    foundryModelSmallDesc: '預設平衡選項，兼顧品質與資源佔用。',
    foundryModelMedium: 'Whisper Medium（更高品質）',
    foundryModelMediumDesc: '更高準確率，適合性能更強、可接受更大下載和更慢推理的設備。',
    foundryModelLarge: 'Whisper Large V3 Turbo（最高品質）',
    foundryModelLargeDesc: '更高品質的大模型選項，適合高配設備和品質優先場景。',
    ...
    mirrorLabel: '下載鏡像源',
    mirrorDesc: '官方源在國外網路更穩；hf-mirror.com 是國內社區維護的鏡像。',
